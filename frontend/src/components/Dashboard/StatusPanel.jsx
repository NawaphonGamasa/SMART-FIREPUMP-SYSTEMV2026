...
const StatusPanel = ({ stations }) => {
    ...
    return (
        <div className="flex flex-col h-full w-full bg-[#0B1121] text-white border-l border-gray-800 font-sans relative overflow-hidden select-none">
            ...
            {/* --- HEADER --- */}
            <div className="h-auto min-h-[5rem] py-3 sm:py-0 sm:h-20 flex flex-wrap sm:flex-nowrap items-center justify-between px-4 sm:px-6 bg-gray-900/80 backdrop-blur-md border-b border-gray-800 z-10 gap-2 sm:gap-0">
            ...
            {/* --- SUMMARY STATS --- */}
            <div className="grid grid-cols-3 gap-1.5 sm:gap-2 p-2 sm:p-4 border-b border-gray-800 bg-gray-900/30">
            ...
            <div className="flex-1 overflow-y-auto p-3 sm:p-4 space-y-3 custom-scrollbar">
                    ...
                    return (
                        <div key={st.station_id} className={`p-3 sm:p-4 rounded-xl border ${cardStyle} transition-all hover:bg-white/5 relative group`}>
                            ...
                            <div className="flex justify-between items-center mb-2 sm:mb-3">
                                ...
                                <div className={`text-[9px] sm:text-[10px] font-bold px-2 py-0.5 rounded border border-white/10 bg-black/20 ${textClass} tracking-wider`}>
                                    {statusText}
                                </div>
                            </div>
                ...
                <div className="pt-3 sm:pt-4 mt-3 sm:mt-4 border-t border-gray-800/50">
                    <button
                        onClick={() => setIsReportModalOpen(true)}
                        className="flex items-center gap-2 px-4 py-2.5 sm:py-3 bg-blue-600/90 hover:bg-blue-500 border border-blue-500/50 text-gray-200 hover:text-white rounded-xl transition-all duration-300 group shadow-[0_0_15px_rgba(37,99,235,0.2)] w-full justify-center"
